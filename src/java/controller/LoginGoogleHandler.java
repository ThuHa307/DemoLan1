...
//        System.out.println(user);
        ...
        boolean isVerify = user.isVerified_email();
        String name = user.getName();
        System.out.println(CustomerDAO.isExist(email));
        if (isVerify == true && !CustomerDAO.isExist(email)) {
            boolean result = CustomerDAO.addCustomer(name, isVerify, email);
            if (result) {
