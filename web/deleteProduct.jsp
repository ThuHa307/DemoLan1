<%-- 
    ...
    Created on : Mar 7, 2024, 4:11:08 AM
    Author     : PC
--%>
...
<html>
    ...
    <body>
        ...
        <div class="create-form">
            ...
            <form action="deleteproduct" method="post" class="was-validated" >
                <input type="hidden" name="productId" value="${product.id}"/>
                <div class="row mb-3">
                    <label for="name" class="col-sm-2 col-form-label">Tên sản phẩm</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="name" id="name" value="${product.name}" required readonly>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="oriprice" id="oriprice" value="${product.oriPrice}" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="price" class="col-sm-2 col-form-label">Giá bán</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="price" id="price" value="${product.price}" required readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="size" class="col-sm-2 col-form-label">Size</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="size" id="size" value="${product.size}" required readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="quantity" class="col-sm-2 col-form-label">Số lượng</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="quantity" id="quantity" value="${product.quantity}" required readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="type" class="col-sm-2 col-form-label">Phân loại</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="type" id="type" value="${product.type}" required readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="type" class="col-sm-2 col-form-label">Danh mục</label>
                    <div class="col-sm-10">
                        <input class="form-control" list="datalistOptions" name="categoryName" type="text" value="${Category.findName(product.getCategoryId())}" required readonly>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="image" id="image" value="${product.image}" required readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="description" class="col-sm-2 col-form-label">Mô tả sản phẩm</label>
                    <div class="col-sm-10">
                        <textarea class="form-control" id="description" name="description" rows="3" value="${product.description}" readonly></textarea>
                    </div>
                ...
                <fieldset class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="color" id="black" value="black" <c:if test="${color eq 'black'}">checked</c:if> readonly />
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="color" id="blue" value="blue" <c:if test="${color eq 'blue'}">checked</c:if> readonly />
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="color" id="brown" value="brown" <c:if test="${color eq 'brown'}">checked</c:if> readonly />
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="color" id="gray" value="gray" <c:if test="${color eq 'gray'}">checked</c:if> readonly />
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="color" id="green" value="green" <c:if test="${color eq 'green'}">checked</c:if> readonly/>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="color" id="nude" value="nude" <c:if test="${color eq 'nude'}">checked</c:if> readonly/>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="color" id="pink" value="pink" <c:if test="${color eq 'pink'}">checked</c:if> readonly />
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="color" id="red" value="red" <c:if test="${color eq 'red'}">checked</c:if> readonly/>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="color" id="white" value="white" <c:if test="${color eq 'white'}">checked</c:if> readonly/>
                ...
                <div class="btn-submit">
                    <button type="submit" class="btn bg-dark text-white">Xóa sản phẩm</button>
                </div>
